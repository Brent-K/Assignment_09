...
# Brent Kieszling, 2020-September-09, Modified line 27, 50, and 64 to include [] based on how I modified the CD class.
# Brent Kieszling, 2020-September-09, Added data file to line 16
...
lstOfCDObjects = []
file_name = ['TestCD.txt', 'TestTrack.txt', 'TestFullInventory.dat']
