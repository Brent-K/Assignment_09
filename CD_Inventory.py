...
lstFileNames = ['AlbumInventory.txt', 'TrackInventory.txt', 'FullInventory.dat']
...
while True:
    ...
    if strChoice == 'l':
        ...
        cd_obj = PC.DataProcessor.select_cd(lstOfCDObjects, cd_idx)
        ...
        while True:
            ...
            if strSubChoice == 'x':
                ...
                PC.DataProcessor.add_track(tplTrackInfo, cd_obj)
                continue

            elif strSubChoice == 'd':
                IO.ScreenIO.show_tracks(cd_obj)
                continue

            elif strSubChoice == 'r':
                trackID = IO.ScreenIO.track_choice()
                PC.DataProcessor.remove_track(trackID, cd_obj)
                continue
